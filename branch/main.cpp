...
int main(int argc, char* argv[]) {
    ...
    bool bounded, feasible;
    //tie(bounded, tableau) = simplex(tableau);
    tie(bounded, feasible, tableau) = branchandcut(tableau, verbose); //replace false with true for debug info
